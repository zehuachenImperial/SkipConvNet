...
if __name__=='__main__':
	...
	parser.add_argument('--audiofile',  type=str,   help='Location for scp file with audio locations',  required=True)
	parser.add_argument('--model',      type=str,   help='Absolute path for saved model   (default: ./Saved_Models/best_model.ckpt)', default='./Saved_Models/best_model.ckpt')
	...
	audiofilelist = __readscpFiles__(args.audiofile)
